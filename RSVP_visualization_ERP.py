...
targetEEG = preproc.extractEpoch3D(data, targetID, srate, baseline, frame, True)
nontargetEEG = preproc.extractEpoch3D(data, nontargetID, srate, baseline, frame, True)
